The files `Id_2D.gif` and `Id_3D.gif` show the evolution of the dynamics through the layers for $V_k = \alpha_k I_d$, $\alpha_k \geq 0$, with $d = 2$ and $d = 3$ respectively.
